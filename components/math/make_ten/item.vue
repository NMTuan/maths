<template>
    <div class="flex items-baseline flex-shrink-0 w-full sm:w-1/3 print:w-1/3 mb-3 text-lg">
        ...
        <div class="relative">
            ...
            <div class="mt-6" :class="showTen ? 'ml-7' : 'ml-4'">
                {{ showTen ? '10' : '(____)' }}
            </div>
            <div class="border-cool-gray-800 border-l border-b h-18 w-10 left-5 top-8 absolute">
                <div class="absolute right-0 bottom-0 w-4 h-4  border-cool-gray-800 border-r">
                </div>
            </div>
        </div>
    </div>
