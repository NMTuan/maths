...
<template>
    <div class="h-full">
        <simplebar class="simplebar h-full">
            ...
            <div class="bg-cool-gray-200/50 py-32 overflow-hidden">
                <div class="mx-auto container overflow-hidden text-center">
                    <h1 class="text-6xl font-black text-blue-400">习题打印生成器</h1>
