 ...
 * @LastEditTime: 2023-03-24 17:19:55
 * @LastEditors: NMTuan
 * @Description: 
...
<template>
    <LayoutPaper title="数独">
        <button class="border px-4 py-1 rounded bg-gray-200" @click="generateSudoku(4)">4</button>
        <button class="border px-4 py-1 rounded bg-gray-200" @click="generateSudoku(6)">6</button>
        <button class="border px-4 py-1 rounded bg-gray-200" @click="generateSudoku(9)">9</button>
